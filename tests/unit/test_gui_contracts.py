        ...
        dl_result=DLResult(
            ...
            steps=[
                DLStepResult(
                    ...
                    bg=None, bg_rb_per_scf=None, bo=1.48, bt=1.48,
                    ...
                    cumulative_gas_produced=0.0, cumulative_gas_produced_scf_stb=0.0,
                    liquid_moles_remaining=1.0,
                ),
                DLStepResult(
                    pressure_pa=5.0e6, rs=210.0, rs_scf_stb=210.0 * 5.615,
                    bg=0.0048, bg_rb_per_scf=0.0048 / 5.615, bo=1.18, bt=1.23,
                    ...
                    cumulative_gas_produced=410.0, cumulative_gas_produced_scf_stb=410.0 * 5.615,
